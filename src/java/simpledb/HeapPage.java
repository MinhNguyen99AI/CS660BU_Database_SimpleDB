...
public class HeapPage implements Page {
    ...
    boolean dirty = false;
    private TransactionId dirty_transactionId;
    ...
    */
    ...
    public void deleteTuple(Tuple t) throws DbException {
    	...
    	if((recordId.getPageId() != this.pid) || (!isSlotUsed(recordId.tupleno()))) {
    		throw new DbException("Cant delete tuple");
    		
    	}
    	else {
    		markSlotUsed(recordId.tupleno(), false);
    		tuples[recordId.tupleno()] = null;
    	}
    }
    ...
    public void insertTuple(Tuple t) throws DbException {
    	...
    	if(getNumEmptySlots() > 0 && t.getTupleDesc().equals(td))  {
    		...
    		if (!allUsed) {
    			RecordId unUsed = new RecordId(pid, unUsed_index);
    			t.setRecordId(unUsed);
    			tuples[unUsed_index] = t;
    			markSlotUsed(unUsed_index, true);
    		}
    		else {
    			throw new DbException("Can not insert tuple");
    		}
    	}
    	else {
    		throw new DbException("Can not insert tuple");
	...
	// not necessary for lab1|lab2
    	if (!dirty) {
    		dirty_transactionId = null;
    	}
    	else
    		dirty_transactionId = tid;
    }
