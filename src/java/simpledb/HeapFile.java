...
public class HeapFile implements DbFile {
    ...
    public void writePage(Page page) throws IOException {
    	...
    	file.seek(page.getId().pageNumber() * pagesize);
    	file.write(page.getPageData(), 0 ,pagesize);
    	file.close();
    }
    ...
    public ArrayList<Page> insertTuple(TransactionId tid, Tuple t)
    	...
    	for (int i = 0; i < this.numPages(); i++) {
    		...
    		HeapPageId newId = new HeapPageId(this.getId(), i);
    		newPage = (HeapPage) Database.getBufferPool().getPage(tid, newId, Permissions.READ_WRITE);
    	...
    	if (newPages.isEmpty()) {
    		HeapPageId newId2 = new HeapPageId(this.getId(), this.numPages());
    		newPage = new HeapPage(newId2, HeapPage.createEmptyPageData());
    		newPage.insertTuple(t);
    ...
    public ArrayList<Page> deleteTuple(TransactionId tid, Tuple t) throws DbException,
        ...
        // some code goes here
    	PageId newId = t.getRecordId().getPageId();
    	ArrayList<Page> returnListDelPage = new ArrayList<Page>();
    	HeapPage targetPage = (HeapPage) Database.getBufferPool().getPage(tid, newId, Permissions.READ_WRITE);
    	targetPage.deleteTuple(t);
    	returnListDelPage.add(targetPage);
        return returnListDelPage;
        // not necessary for lab1|lab2
    }
